...
function onSearch() {
    ...
    load('DOOR PANEL', getFilter("series"), localStorage.getItem("usr_val"), localStorage.getItem("type_val"));
}
                        ...
                        <thead>
                            <tr>
                                ...
                                <th style="display: flex; align-items: center; text-align: right;">
                                    ...
                                    <div class="col-sm-12" style="color:green;">(ยอดในคลัง)</div>
                                </th>
                                
                                <th style="display: flex; align-items: center; text-align: right;">
                                    <div class="col-sm-12">OnOrder</div>
                                    <div class="col-sm-12" style="color:green;">(สั่งขาย)</div>
                                </th>
            ...
            for (let data of objects)
            {
                ...
                if (_seq > 0) {
                    ...
                    <tr >
                                    ...
                                    <td style="display: flex; align-items: center; text-align: right;">${numberFormat(_phyInv - _onOrder)}</td>
                                    <td>${_unit}</td>
                                </tr>
                                `;
                                rowCount++;
